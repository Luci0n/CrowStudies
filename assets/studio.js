(function(){
  ...
  function blockHTML(block){
    ...
    if(block.type==='code'){
      ...
      body='<div class="code-wrap'+(block.codeWrap?' is-wrapped':'')+'" style="--code-height:'+codeHeight+'px"><div class="code-tools"><label class="code-language" title="Language"><span>Language</span><select data-code-language'+disabled+'>'+languageOptions+'</select></label><label class="code-height" title="Editor height"><span>Height</span><input type="range" data-code-height min="180" max="720" step="20" value="'+codeHeight+'"'+disabled+'></label><div class="code-actions"><button type="button" class="code-wrap-toggle" data-code-wrap aria-pressed="'+(block.codeWrap?'true':'false')+'">Wrap</button><button type="button" class="code-size" data-code-size aria-expanded="false"><span data-size-word>Expand</span><span class="code-size-mark" aria-hidden="true"></span></button><button type="button" class="code-copy" data-code-copy title="Copy this code">'
